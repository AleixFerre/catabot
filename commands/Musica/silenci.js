...
const { silent_mode, getServerQueue } = require('../../lib/musicModule.js');

module.exports = {
  name: 'silenci',
  description: 'Alterna el MODE SILENCI. Aquest fa que el bot no mostri la cançó actual quan passa a la següent cançó.',
  type: TYPE,
