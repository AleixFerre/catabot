...
module.exports = {
    ...
    cercar_video: async (args, message) => {
    ...
    queue_constructor_generic: (voice_channel, message) => {
        return {
    ...
    sortir_i_esborrar: (song_queue, guild, abandonat) => {
    ...
    video_player: async (guild, song, voice_channel_name) => {
    ...
    enviarError: async (message, str, err) => {
