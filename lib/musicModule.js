...
module.exports = {
  ...
  switch_loop: (message, server_queue) => {
    ...
    let embed = new Discord.MessageEmbed().setColor(getColorFromCommand(TYPE)).setTitle(`🔁 ${paraula} loop...`);
    message.channel.send(embed);
  },
  ...
  mostrar_opcions: (message, server) => {
    ...
    let embed = new Discord.MessageEmbed()
      ...
      .addField(
        `❯ ${prefix}play < URL / cerca >`,
        "El bot s'unirà al teu canal de veu i reproduirà les cançons que vulguis.",
        false
      )
      .addField(
        `❯ ${prefix}playNow < URL / cerca >`,
        'Posa una cançó ara mateix.\nLa comanda respectarà la cua següent però es passarà la cançó actual.',
        false
      )
      ...
      .addField(
        `❯ ${prefix}stop / disconnect`,
        "No vols més musica? El bot s'envà del canal esborrant les cançons de la llista.",
        false
      )
      ...
      .addField(
        `❯ ${prefix}volume [ n ]`,
        'Posa un nou volum de la reproducció. Et mostra el volum actual si no es passa cap paràmetre.',
        false
      )
      .addField(
        `❯ ${prefix}loop`,
        'Alterna el mode LOOP. Quan està activat, el bot reproduirà la mateixa cançó una i altra vegada.',
        false
      )
      .addField(
        `❯ ${prefix}silent/ silentMode`,
        'Alterna el mode SILENT. Aquest fa que el bot no mostri la cançó actual quan passa a la següent cançó.',
        false
      )
